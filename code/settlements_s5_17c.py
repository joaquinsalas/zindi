...
def main():
    h5_file = '../../2024.09.04zindi/data/train_data.h5'
    batch_size = 512
    epochs = 1000
    patience = 0
        ...
        for epoch in range(epochs):
            ...
            if val_auc > best_val_auc:
                ...
                if val_auc > overall_best_val_auc:
                    ...
                    torch.save(model.state_dict(), 'settlements/best_s5_model_17c.pth')
...
model_save_path = 'settlements/best_s5_model_17c.pth'  # Path to save and load the best model
